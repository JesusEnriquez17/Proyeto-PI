...
# Crear botones
main_buttons = [
    Button("Nivel 1", 130, 427, 240, 82, (4, 184, 242), (3, 145, 191), start_game),
    Button("Nivel 2", 380, 427, 240, 82, (4, 184, 242), (3, 145, 191), show_options),
    Button("Nivel 3", 630, 427, 240, 82, (4, 184, 242), (3, 145, 191), show_controls),
